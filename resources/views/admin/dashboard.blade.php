...
@section('content')
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        <div class="bg-gradient-to-r from-red-500 to-red-700 p-6 rounded-lg shadow-md text-white">
            <h2 class="text-lg font-semibold">Total Articles</h2>
            <p class="text-2xl font-bold mt-2">{{ $totalNews }}</p>
            <div class="mt-4 flex items-center justify-between">
                <span class="text-blue-200">Total Articles Published</span>
        ...
        <div class="bg-gradient-to-r from-orange-500 to-orange-700 p-6 rounded-lg shadow-md text-white">
            <h2 class="text-lg font-semibold">Total Categories</h2>
            <p class="text-2xl font-bold mt-2">{{ $totalCategories }}</p>
            <div class="mt-4 flex items-center justify-between">
                <span class="text-green-200">Active Categories</span>
        ...
        <div class="bg-gradient-to-r from-yellow-500 to-yellow-700 p-6 rounded-lg shadow-md text-white">
            <h2 class="text-lg font-semibold">Users Active</h2>
            <p class="text-2xl font-bold mt-2">{{ $totalUsers }}</p>
            <div class="mt-4 flex items-center justify-between">
                <span class="text-purple-200">Registered Users</span>
